...
func (rcv *ResultItem) Doc(obj *Doc) *Doc {
...
func ResultItemAddDoc(builder *flatbuffers.Builder, doc flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(1, flatbuffers.UOffsetT(doc), 0)
}
