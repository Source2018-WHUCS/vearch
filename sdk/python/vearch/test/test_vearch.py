...
class TestVearchBadcase(object):
    ...
    @pytest.mark.parametrize('database_name, space_schema',
                             [("database_test_v",SpaceSchema("book_info_ivfpq", [book_name, book_num, Field("book_character", DataType.VECTOR, IvfPQIndex("book_vec_idx", 10000, MetricType.Inner_product, 2048, 8), dimension=512)])),
                              ("database_test_v",SpaceSchema("book_info_ivfflat", [book_name, book_num, Field("book_character", DataType.VECTOR, IvfFlatIndex("book_vec_idx", MetricType.Inner_product, 2048), dimension=512)])),
                              ...
                              ("database_test_v",SpaceSchema("book_info_flat", [book_name, book_num, Field("book_character", DataType.VECTOR, FlatIndex("book_vec_idx", MetricType.Inner_product), dimension=512)])),
                              ("database_test_v",SpaceSchema("book_info_hnsw", [book_name, book_num, Field("book_character", DataType.VECTOR, HNSWIndex("book_vec_idx", MetricType.Inner_product, 32, 40), dimension=512)])),
    ...
    # @pytest.mark.parametrize('database_name, space_schema',
    #                          [
                                 # ("database_new",SpaceSchema("book_info_ivfpq", [book_name, book_num, Field("book_character", DataType.VECTOR, IvfPQIndex("book_vec_idx", 10000, MetricType.Inner_product, 2048, 8), dimension=512)])),
    #                          ])
    ...
    @pytest.mark.parametrize('database_name, space_name',
    ...
    @pytest.mark.parametrize('database_name, space_name, data',
    ...
    @pytest.mark.parametrize('database_name, space_name, ids,filters',
    ...
    @pytest.mark.parametrize('database_name, space_name, vec_info,filters,limit',
                             [("database_test_v","book_info_ivfpq",[vi, ],search_filters,3),
                             ])    
    def test_search(self,database_name, space_name, vec_info, filters, limit):
        ret = vc.search(database_name, space_name, vector_infos=[vi,], filter=filters, limit=limit)
        assert ret.code == 0 
        

    @pytest.mark.parametrize('database_name, space_name, vec_info,filters,limit',
                             [("db_test","book_info_ivfpq",[vi, ],search_filters,3),
                              ("db_test","book_info_ivfpq",[vi, ],None,None),
                              ("db_test","book_info_ivpq",[vi, ],None,None),
                             ])    
