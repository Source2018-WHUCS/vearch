...
CATALOG=(
    "m1.api|8817|main,ps2,ps3"
    "m1.etcd|2378|main,ps2,ps3"
    "m1.etcd_peer|2390|main,ps2,ps3"
    "m1.etcd_client|2370|main,ps2,ps3"
    "m1.pprof|6062|main,ps2,ps3"
    "m1.monitor|8828|main,ps2,ps3"
    "m2.api|8827|main,ps2,ps3"
    "m2.etcd|2379|main,ps2,ps3"
    "m2.etcd_peer|2391|main,ps2,ps3"
    "m2.etcd_client|2371|main,ps2,ps3"
    "m2.pprof|6072|main,ps2,ps3"
    "m2.monitor|8829|main,ps2,ps3"
    "m3.api|8837|main,ps2,ps3"
    "m3.etcd|2380|main,ps2,ps3"
    "m3.etcd_peer|2392|main,ps2,ps3"
    "m3.etcd_client|2372|main,ps2,ps3"
    "m3.pprof|6082|main,ps2,ps3"
    "m3.monitor|8830|main,ps2,ps3"
    "router.http|9001|main,ps2,ps3"
    "router.pprof|6061|main,ps2,ps3"
    "ps1.rpc|8081|main"
    "ps1.raft_heartbeat|8898|main"
    "ps1.raft_replicate|8899|main"
    "ps1.pprof|6060|main"
    "ps2.rpc|8082|ps2"
    "ps2.raft_heartbeat|8900|ps2"
    "ps2.raft_replicate|8901|ps2"
    "ps2.pprof|6063|ps2"
    "ps3.rpc|8083|ps3"
    "ps3.raft_heartbeat|8902|ps3"
    "ps3.raft_replicate|8903|ps3"
    "ps3.pprof|6064|ps3"
)
