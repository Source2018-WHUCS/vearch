...
def check(total, bulk, full_field, xb):
    dim = xb.shape[1]
    batch_size = 1
    if bulk:
        batch_size = 100
...
def test_module_filter(bulk: bool, full_field: bool):
    check(100, bulk, full_field, xb)
