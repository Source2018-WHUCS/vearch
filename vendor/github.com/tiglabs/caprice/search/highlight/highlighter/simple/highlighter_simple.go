...
import (
	...
	"github.com/tiglabs/caprice/search/highlight"
...
func (s *Highlighter) BestFragmentInField(dm *match.DocumentMatch, doc *document.Document, field string) string {
...
func (s *Highlighter) BestFragmentsInField(dm *match.DocumentMatch, doc *document.Document, field string, num int) []string {
