...
type Highlighter interface {
	...
	// only work for text field
	BestFragmentInField(*match.DocumentMatch, *document.Document, string) string
	BestFragmentsInField(*match.DocumentMatch, *document.Document, string, int) []string
}
