// Copyright (c) The influxdb Authors. All rights reserved.
// https://github.com/influxdata/influxdb/tree/master/toml
// this package adds support to marshal and unmarshal types not in the official TOML spec.
package toml
